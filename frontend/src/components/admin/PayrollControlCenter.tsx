            ...
            {activeTab === 'salary' && (
                <div className="bg-white rounded-[44px] border border-slate-50 shadow-sm overflow-hidden">
                    <div className="p-10 border-b border-slate-50 bg-slate-50/20 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <Badge className="bg-indigo-50 text-indigo-600 border-none font-black text-[9px] px-3 py-1.5 rounded-full">{(Array.isArray(users) ? users.length : 0)} Active Personnel</Badge>
                        </div>
                    </div>
