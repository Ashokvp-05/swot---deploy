        ...
        <Card className="border border-slate-200 dark:border-slate-800 shadow-sm bg-white dark:bg-slate-900 rounded-[2.5rem] overflow-hidden">
            <div className="p-10 pb-6 border-b border-slate-50 dark:border-white/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="space-y-1">
                    <h3 className="text-2xl font-bold uppercase italic text-slate-900 dark:text-white">Ticket <span className="text-indigo-600">Registry</span></h3>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button variant="outline" className="h-10 rounded-xl font-bold uppercase text-[10px] tracking-widest px-6 italic">Filter ▽</Button>
                </div>
            </div>
            <CardContent className="p-10">
                <div className="flex flex-col items-center justify-center p-20 text-center space-y-4">
                    <Ticket className="w-12 h-12 text-slate-200" />
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest italic">No active support tickets found in this shard</p>
                </div>
            </CardContent>
        </Card>
    )
