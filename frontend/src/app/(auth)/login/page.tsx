                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-[480px] relative">
                        ...
                        <div className="glass-card rounded-[2.5rem] p-10 lg:p-12 relative z-10 border border-white/5">
                            ...
                            <div className="text-center mb-10">
                                <h2 className="text-2xl font-bold text-white uppercase tracking-tighter leading-none mb-1">WELCOME BACK</h2>
                            ...
                            <form onSubmit={handleLogin} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="input-shard rounded-xl flex items-center px-4 h-14">
                                        <Input 
                                            ...
                                            className="bg-transparent border-none text-white focus-visible:ring-0 focus-visible:ring-offset-0 text-sm h-full w-full placeholder:text-slate-700 [&:-webkit-autofill]:transition-colors [&:-webkit-autofill]:duration-[99999s] [&:-webkit-autofill]:[-webkit-text-fill-color:white]" 
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link href="/forgot-password" className="text-[10px] text-indigo-400 font-bold uppercase tracking-widest transition-colors hover:text-indigo-300">Forgot Password?</Link>
                                </div>

                                <Button type="submit" disabled={loading} className="w-full h-14 mt-6 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-2xl shadow-xl shadow-indigo-600/30 uppercase tracking-widest text-[11px] transition-all active:scale-[0.98]">
                                    {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : "SIGN IN NOW"}
                                </Button>
                            </form>

                            <div className="my-8 text-[10px] font-bold text-slate-700 text-center uppercase tracking-[0.3em]">FAST ACCESS</div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <Button className="social-btn h-14 rounded-2xl flex items-center justify-center gap-3">
                                    ...
                                    <span className="text-[10px] font-bold tracking-widest">GOOGLE</span>
                                </Button>
                                <Button className="social-btn h-14 rounded-2xl flex items-center justify-center gap-3">
                                    ...
                                    <span className="text-[10px] font-bold tracking-widest">MICROSOFT</span>
                                </Button>
                            </div>

                            <p className="mt-10 text-[9px] font-bold text-slate-800 uppercase tracking-[0.4em] text-center select-none opacity-50">
